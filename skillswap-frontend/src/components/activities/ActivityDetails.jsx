...
const ActivityDetails = () => {
    ...
    return (
        <div className="w-full lg:w-96 bg-[#101726] border-l border-white/10 h-full flex flex-col 
      fixed lg:relative 
      ...
      transition-transform duration-300">
            ...
            <div className="p-4 flex items-center justify-between border-b border-white/10">
                <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-full ${selectedActivity.category === 'Running' ? 'bg-purple-500/20 text-purple-400' :
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3 text-gray-400">
                            ...
                            <div>
                                ...
                                <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${selectedActivity.isOnline ? 'bg-green-500/20 text-green-400' : 'bg-white/10 text-gray-300'
                                    }`}>
