...
const ActivityChat = () => {
  ...
  return (
    <div className="flex flex-col h-[300px] bg-gray-50">
      <div className="p-3 bg-white border-b border-gray-100">
        <h3 className="text-sm font-bold text-gray-900">Meetup Lounge</h3>
        <p className="text-xs text-gray-500">Coordinate with the group</p>
      </div>
      ...
      <form onSubmit={handleSend} className="p-3 bg-white border-t border-gray-100 flex gap-2">
        <input
          ...
          className="flex-1 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00C4FF]"
        />
        <button 
          type="submit"
