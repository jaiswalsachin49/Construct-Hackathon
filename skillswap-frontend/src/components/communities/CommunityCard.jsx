...
const CommunityCard = ({ community, onJoin }) => {
  ...
  return (
    <div
      ...
      className="bg-[#101726] rounded-lg shadow-sm hover:shadow-lg transition-all overflow-hidden cursor-pointer border border-white/10 hover:border-[#3B82F6]/30 relative group"
      style={{
