...
//                                 />
//                             </div>
//                             <span className="text-3xl font-extrabold -skew-x-6 tracking-tight bg-gradient-to-r from-[#60A5FA] to-[#3B82F6] bg-clip-text text-transparent -ml-1">
//                                 killSwap
//                             </span>
//                         </div>
...
//                     Learn. Teach.{' '}
//                     <span className="bg-gradient-to-r from-[#3B82F6] to-[#7A3EF9] bg-clip-text text-transparent">
//                         Connect.
//                     </span>
//                 </h1>
...
//                                 <div className="mx-auto h-16 w-16 rounded-full bg-gradient-to-br from-[#3B82F6] to-[#7A3EF9] flex items-center justify-center shadow-lg">
...
//                     bg-gradient-to-r from-[#7A3EF9] via-[#3B82F6] to-[#60A5FA]">
...
import AboutSection from './landingSection/about'
import AboutFeatures from './landingSection/Features'
import Showcase from './landingSection/showCase'
import UniqueOpportunity from './landingSection/UniqueOpportunity'
